...
export class RateLimitedTendermint34Client {
  ...
  public async abciQuery(
    ...
    return await this.rateLimiter.schedule(() =>
      this.tmClient.abciQuery(params)
    );
  }
  public async blockchain(
    ...
    return await this.rateLimiter.schedule(() =>
      this.tmClient.blockchain(minHeight, maxHeight)
    );
  }
  ...
  public async blockSearch(
    params: requests.tendermint34.BlockSearchParams
  ): Promise<requests.tendermint34.BlockSearchResponse> {
    return await this.rateLimiter.schedule(() =>
      this.tmClient.blockSearch(params)
    );
  }
  public async blockSearchAll(
    ...
    return await this.rateLimiter.schedule(() =>
      this.tmClient.blockSearchAll(params)
    );
  }
  ...
  public async broadcastTxSync(
    ...
    return await this.rateLimiter.schedule(() =>
      this.tmClient.broadcastTxSync(params)
    );
  }
  ...
  public async broadcastTxAsync(
    ...
    return await this.rateLimiter.schedule(() =>
      this.tmClient.broadcastTxAsync(params)
    );
  }
  ...
  public async broadcastTxCommit(
    ...
    return await this.rateLimiter.schedule(() =>
      this.tmClient.broadcastTxCommit(params)
    );
  }
  ...
  public async validators(
    ...
    return await this.rateLimiter.schedule(() =>
      this.tmClient.validators(params)
    );
  }
  ...
  public async validatorsAll(
    ...
    return await this.rateLimiter.schedule(() =>
      this.tmClient.validatorsAll(height)
    );
  }
}
