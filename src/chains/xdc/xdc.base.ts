...
// information about an Xdc token
...
export class XdcBase {
  ...
  // xdc token lists are large. instead of reloading each time with
  ...
  // returns an xdc TransactionResponse for a txHash.
  ...
  // returns an xdc TransactionReceipt for a txHash if the transaction has been mined.
