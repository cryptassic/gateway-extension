...
import {
  ...
  MigrateMsg,
  ConfigResponse,
  NativeTokenDecimalsResponse,
  PairInfo,
  PairsResponse,
  TrioInfo,
  TriosResponse,
} from './TerraswapFactory.types';
export interface TerraswapFactoryReadOnlyInterface {
  ...
  trio: ({ assetInfos }: { assetInfos: AssetInfo[] }) => Promise<TrioInfo>;
  trios: ({
    limit,
    startAfter,
  }: {
...
export class TerraswapFactoryQueryClient
  implements TerraswapFactoryReadOnlyInterface
{
...
export interface TerraswapFactoryInterface
  extends TerraswapFactoryReadOnlyInterface {
  contractAddress: string;
  sender: string;
  updateConfig: (
    {
...
export class TerraswapFactoryClient
  extends TerraswapFactoryQueryClient
  implements TerraswapFactoryInterface
{
